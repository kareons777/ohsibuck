...
UCLASS()
class PRACTICE3_API ASimpleCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:	
	...
	UPROPERTY() UInventoryComponent* MyInventory;
	virtual void SetupPlayerInputComponent( UInputComponent* InputComponent ) override;
	UFUNCTION() void DropItem();
	UFUNCTION() void TakeItem( AInventoryActor* InventoryItem );
